...
export default {
  ...
  data () {
    const cloudEnvOptions = getCloudEnvOptions('compute_engine_brands', true).filter(item => item.key !== 'public')
  ...
  computed: {
    ...
    headerTitle () {
      return this.isInstallOperationSystem ? this.$t('compute.text_298') : this.$t('compute.text_299')
    },
  },
  watch: {
    cloudEnv (val) {
